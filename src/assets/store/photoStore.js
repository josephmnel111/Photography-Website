            ...
            RemovePicturesByTag(tags) {
                for (let i = 0; i < this.photos.length; ++i) {
                    for (let j = 0; j < this.photos[i].data.tags.length; ++j) {
                        if (this.photos[i].data.tags[j] == tags) {
